                    ...
                    <div class="chat-message">
                        ...
                        @if ($user->id == $support->user->id)
                            <div class="flex items-end">
                                ...
                                <img src="{{ $user->images ? url("storage/{$user->images}") : url('images/user.png') }}" class="w-6 h-6 rounded-full order-1">
                            </div>
                        @else
                            <div class="flex items-end justify-end">
                                ...
                                <img src="{{ $user->images ? url("storage/{$user->images}") : url('images/user.png') }}" alt="My profile" class="w-6 h-6 rounded-full order-2">
                            </div>
                        @endif
                    </div>
                @endforeach
